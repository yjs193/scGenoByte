...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, gene_size=20400, patch_size=100, in_chans=3,
        ...
        self.blocks = nn.ModuleList([
            FlashAttentionBlock(embed_dim, num_heads, mlp_ratio, qkv_bias=True, attn_drop=0.1, norm_layer=norm_layer)
        ...
        self.decoder_blocks = nn.ModuleList([
            FlashAttentionBlock(decoder_embed_dim, decoder_num_heads, mlp_ratio, qkv_bias=True, norm_layer=norm_layer)
